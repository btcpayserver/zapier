    ...
    operation: {
        ...
        inputFields: [
            ...
            },
            {
                ...
                label: 'Redirect URL',
                type: 'string',
                helpText: 'When the customer has paid the invoice, the URL where the customer will be sent to when clicking on the "Return to store" button. You can use the placeholders `{InvoiceId}` and `{OrderId}` in the URL. BTCPay Server will replace those with this invoice `id` or the `metadata.orderId` values respectively.',
                required: false,
                list: false,
                altersDynamicFields: false,
            },
