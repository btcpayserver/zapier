...
describe('triggers', () => {
    test(App.triggers.InvoiceReceivedPayment.key + ' webhook', async () => {
        ...
        let bundle = {
            ...
            rawRequest: {
                content: '{\n' +
                    ...
                    '  "isRedelivery": false,\n' +
                    '  "type": "'+App.triggers.InvoiceReceivedPayment.key+'",\n' +
        ...
        const results = await appTester(
            App.triggers.InvoiceReceivedPayment.operation.perform,
            bundle
        );
    ...
    test(App.triggers.InvoiceReceivedPayment.key + ' list sample data', async () => {
        ...
        const results = await appTester(
            App.triggers.InvoiceReceivedPayment.operation.performList,
            bundle
        );
