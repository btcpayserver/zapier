...
describe('triggers', () => {
    test(App.triggers.InvoiceExpired.key + ' webhook', async () => {
        ...
        let bundle = {
            ...
            rawRequest: {
                content: '{\n' +
                    ...
                    '  "isRedelivery": false,\n' +
                    '  "type": "'+App.triggers.InvoiceExpired.key+'",\n' +
        ...
        const results = await appTester(
            App.triggers.InvoiceExpired.operation.perform,
            bundle
        );
    ...
    test(App.triggers.InvoiceExpired.key + ' list sample data', async () => {
        ...
        const results = await appTester(
            App.triggers.InvoiceExpired.operation.performList,
            bundle
        );
